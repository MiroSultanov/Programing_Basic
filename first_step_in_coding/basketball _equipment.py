# Jesse decides he wants to play basketball, but he needs equipment to train. Write a program that calculates what costs Jesse will have if he starts training, knowing how much the basketball training fee is for a period of 1 year. Required equipment:
